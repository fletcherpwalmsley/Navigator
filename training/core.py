'''
Holds core helper functions and imports

TODO: Could split stuff out into more specific areas down the road
'''
import os
import numpy as np
...
def UNetCompiled(input_size=(96, 96, 3), n_filters=32, n_classes=3):
    """
